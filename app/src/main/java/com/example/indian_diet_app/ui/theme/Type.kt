...
// Using system default font to avoid GoogleFont provider crash
// (GoogleFont requires GMS certificate validation which can fail on some devices)
...
val Typography = Typography(
    ...
    titleMedium   = TextStyle(fontFamily = FontFamily.Default, fontWeight = FontWeight.Medium,    fontSize = 14.sp, lineHeight = 22.sp, letterSpacing = 0.1.sp),
    ...
    labelLarge    = TextStyle(fontFamily = FontFamily.Default, fontWeight = FontWeight.SemiBold,  fontSize = 13.sp, lineHeight = 20.sp, letterSpacing = 0.1.sp),
